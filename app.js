...
function myDate(){
    ...
    const mins = String(date.getMinutes()+1).padStart(2, '0');
    ...
    const fullTime =[hour, mins, secs].join(':');
    ...
    //console.log(fullTime);
          ...
          var last="00:00:00";
          var now = fullDate + " 23:59:00";
    
          //console.log("Esta es la fecha del reloj: " + now);
    ...
    $( document ).ready(function() {
          ...
          document.getElementById("my3").loop = true;